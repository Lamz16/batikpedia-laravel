                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample">
                    <div class="form-group">
                      <label for="exampleInputName1">Nama Provinsi</label>
                      <input type="text" class="form-control" id="exampleInputName1" placeholder="Nama Provinsi">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="exampleTextarea1">Detail Provinsi</label>
